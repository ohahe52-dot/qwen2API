...
export default function SettingsPage() {
  ...
  const fetchSettings = useCallback(() => {
    fetch(`${API_BASE}/api/admin/settings`, { headers: getAuthHeader() })
      ...
      .catch(() => toast.error(t("settings.fetchError")))
  }, [t])
  ...
  const handleSaveSessionKey = () => {
    if (!sessionKey.trim()) {
      toast.error(t("settings.needKey"))
      return
    }
    ...
    <div className="w-full max-w-5xl mx-auto min-w-0 overflow-x-hidden space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        ...
        <Button variant="outline" onClick={() => {fetchSettings(); toast.success(t("settings.configRefreshed"))}}>
          <RefreshCw className="mr-2 h-4 w-4" /> {t("settings.refreshBtn")}
        </Button>
      </div>
      ...
      <div className="grid gap-6 min-w-0">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold leading-none tracking-tight">{t("settings.sessionKeyTitle")}</h3>
            </div>
          ...
          <div className="p-6">
            <div className="flex gap-2 items-center flex-wrap">
              ...
              />
              <Button onClick={handleSaveSessionKey}>{t("settings.saveBtn")}</Button>
              <Button variant="ghost" onClick={handleClearSessionKey}>{t("settings.clearBtn")}</Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold leading-none tracking-tight">{t("settings.connectionTitle")}</h3>
            </div>
          </div>
          <div className="p-6">
            <div className="space-y-1 min-w-0">
              <label className="text-sm font-medium">{t("settings.baseUrlLabel")}</label>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold leading-none tracking-tight">{t("settings.coreTitle")}</h3>
            </div>
            <p className="text-sm text-muted-foreground">{t("settings.coreDesc")}</p>
          </div>
          <div className="p-6 space-y-4">
            <div className="flex justify-between items-center py-2 border-b flex-wrap gap-2">
              <div className="space-y-1 min-w-0">
                <span className="text-sm font-medium">{t("settings.versionLabel")}</span>
              </div>
            ...
            <div className="flex justify-between items-center py-2 border-b flex-wrap gap-4">
              <div className="space-y-1 min-w-0 flex-1">
                <span className="text-sm font-medium">{t("settings.maxInflightLabel")}</span>
            ...
            <div className="flex justify-between items-center py-2 border-b flex-wrap gap-4">
              <div className="space-y-1 min-w-0 flex-1">
                <span className="text-sm font-medium">{t("settings.globalMaxLabel")}</span>
            ...
            <div className="flex justify-end">
              <Button size="sm" onClick={handleSaveConcurrency}>{t("settings.saveConcurrencyBtn")}</Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold leading-none tracking-tight">{t("settings.poolTitle")}</h3>
            </div>
          ...
          <div className="p-6 space-y-4">
            <div className="flex justify-between items-center py-2 border-b flex-wrap gap-4">
              <div className="space-y-1 min-w-0 flex-1">
                <span className="text-sm font-medium">{t("settings.poolTargetLabel")}</span>
            ...
            <div className="flex justify-between items-center py-2 border-b flex-wrap gap-4">
              <div className="space-y-1 min-w-0 flex-1">
                <span className="text-sm font-medium">{t("settings.poolTtlLabel")}</span>
            ...
            <div className="flex justify-end">
              <Button size="sm" onClick={handleSavePool}>{t("settings.savePoolBtn")}</Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <h3 className="font-semibold leading-none tracking-tight">{t("settings.aliasesTitle")}</h3>
          ...
          <div className="p-6">
            ...
            <div className="mt-4 flex justify-end">
              <Button onClick={handleSaveAliases}>{t("settings.saveAliasesBtn")}</Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm min-w-0">
          <div className="flex flex-col space-y-1.5 p-6 border-b bg-muted/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold leading-none tracking-tight">{t("settings.exampleTitle")}</h3>
            </div>
          </div>
